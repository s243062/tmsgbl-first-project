...
export default function ScreenTimeOverview() {
  ...
  const navigateToGardenerOverview = () => {
    navigation.navigate('gardener_overview');
  };
  ...
  const navigateToSteps = () => {
    navigation.navigate('steps_overview');
  };
      ...
      >
        ...
        <View style={styles.highlightBubble}>
          <Text style={styles.highlightText}>
            You've reduced your screen time by 20% this week-Sprouty is flourishing with the extra attention! Your evening screen-free time has increased by 45 minutes on average <Text>🌱</Text>. Wonderful progress!
          </Text>
        </View>
        
        {/* Activity Correlations section */}
        <Text style={styles.CorrelationTitle}>Activity Correlations</Text>
        <View style={styles.correlationCard}>
          <Text style={styles.correlationText}>
            • On days with less screen time, you tend to get better sleep <Text>🌙</Text> <Text style={styles.sleepIcon}>💤</Text> and take more steps the following day :))
          </Text>
        </View>
        ...
        >
          <View style={styles.tipsContainer}>
            <Text style={styles.tipItem}>• Set screen time limits for specific apps to reduce overall usage</Text>
            <Text style={styles.tipItem}>• Try the 20-20-20 rule: every 20 minutes, look at something 20 feet away for 20 seconds</Text>
          </View>
        </List.Accordion>
