      ...
      >
        ...
        <View style={styles.highlightBubble}>
          <Text style={styles.highlightText}>
            You've met your sleep goal 5 nights this week-Sprouty is thriving with your rest! Your average sleep duration has increased by 8% compared to last week <Text>🌙</Text>. Keep up the restful nights!
          </Text>
        </View>
        ...
        <View style={styles.correlationCard}>
          <Text style={styles.correlationText}>
            • On days when you get 7+ hours of sleep, you tend to take more steps <Text>👣</Text> and have 30% less screen time the following day :))
          </Text>
        </View>
        ...
        >
          <View style={styles.tipsContainer}>
            <Text style={styles.tipItem}>• Try to maintain a consistent sleep schedule, even on weekends</Text>
            <Text style={styles.tipItem}>• Avoid screen time at least 30 minutes before bedtime to improve sleep quality</Text>
          </View>
        </List.Accordion>
