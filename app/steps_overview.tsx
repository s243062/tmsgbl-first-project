      ...
      >
        ...
        <View style={styles.highlightBubble}>
          <Text style={styles.highlightText}>
            You've hit your step goal 4 times this week-Sprouty loves the energy! Your average for this week has been 15% lower compared to previous week <Text>🌻</Text>. Keep the good work!
          </Text>
        </View>
        ...
        <View style={styles.correlationCard}>
          <Text style={styles.correlationText}>
            • On average, you tend to walk more throughout the day when you reach your sleep <Text>🌙</Text> <Text style={styles.sleepIcon}>💤</Text> goal at least 4 days in a week :))
          </Text>
        </View>
        ...
        >
          <View style={styles.tipsContainer}>
            <Text style={styles.tipItem}>• Take a walk after meals to boost digestion</Text>
            <Text style={styles.tipItem}>• Coming back home, leave one bus stop earlier and take a walk home</Text>
          </View>
        </List.Accordion>
