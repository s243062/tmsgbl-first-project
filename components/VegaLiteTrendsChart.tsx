  ...
  const chartHtml = `
    ...
    <body>
      ...
      <script>
        ...
        const currentProcessed = processData(currentWeekData, currentWeekLabel);
        const previousProcessed = processData(previousWeekData, previousWeekLabel);

        const spec = {
          "$schema": "https://vega.github.io/schema/vega-lite/v5.json",
          "width": "container",
          "height": 300,
          "title": "Weekly Steps Comparison",
          "layer": [
            {
